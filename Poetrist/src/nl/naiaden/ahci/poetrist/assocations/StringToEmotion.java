...
public class StringToEmotion
{
	...
	/**
	 * changes the raw text to a list of words. This function does not determine
	 * whether these words are relevant or not. it just simply splits it into
	 * separate words and returns it as a String array
	 */
